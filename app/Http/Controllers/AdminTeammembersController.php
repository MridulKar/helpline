<?php namespace App\Http\Controllers;
	...
	class AdminTeammembersController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Messanger","name"=>"messanger"];
			...
			$this->form[] = ['label'=>'Messanger','name'=>'messanger','type'=>'text','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Messanger","name"=>"messanger","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Email","name"=>"email","type"=>"email","required"=>TRUE,"validation"=>"required|min:1|max:255|email|unique:teammembers","placeholder"=>"Please enter a valid email address"];
