<?php namespace App\Http\Controllers;
	...
	class AdminSocialsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Icon','name'=>'icon','type'=>'text','validation'=>'required','width'=>'col-sm-10','placeholder'=>'Give here Font Awesome icon'];
			$this->form[] = ['label'=>'Background Color','name'=>'background_color','type'=>'text','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Color','name'=>'color','type'=>'text','width'=>'col-sm-10'];
			...
			//$this->form[] = ['label'=>'Background Color','name'=>'background_color','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
