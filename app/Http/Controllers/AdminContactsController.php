<?php namespace App\Http\Controllers;
	...
	class AdminContactsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Email','name'=>'email','type'=>'email','validation'=>'required|min:1|max:255|email|unique:contacts','width'=>'col-sm-10','placeholder'=>'Please enter a valid email address'];
			$this->form[] = ['label'=>'Subject','name'=>'subject','type'=>'text','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Message','name'=>'message','type'=>'text','width'=>'col-sm-10'];
